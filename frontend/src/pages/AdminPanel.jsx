...
const styles = {
  ...
  title: { color: '#1e293b', fontSize: '1.85rem', marginBottom: '1.5rem', fontWeight: '700' },
  tabs: { display: 'flex', gap: '0.5rem', marginBottom: '1.5rem' },
  tab: { padding: '0.65rem 1.5rem', border: '1px solid #e2e8f0', borderRadius: '8px', background: 'white', cursor: 'pointer', color: '#64748b', fontWeight: '600', fontSize: '1rem' },
  activeTab: { background: '#1e40af', color: 'white', borderColor: '#1e40af' },
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' },
  count: { color: '#64748b', fontSize: '1rem' },
  createBtn: { padding: '0.6rem 1.25rem', background: '#1e40af', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '1rem' },
  formCard: { background: 'white', padding: '2rem', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', marginBottom: '1.5rem' },
  formTitle: { color: '#1e293b', marginBottom: '1.25rem', fontSize: '1.2rem', fontWeight: '700' },
  ...
  submitBtn: { padding: '0.85rem 1.5rem', background: '#1e40af', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', alignSelf: 'flex-start', minWidth: '160px', fontSize: '1rem' },
  error: { color: '#dc2626', fontSize: '0.95rem' },
  success: { color: '#16a34a', fontSize: '0.95rem' },
  tableWrapper: { background: 'white', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.07)', overflow: 'auto' },
  table: { width: '100%', borderCollapse: 'collapse' },
  th: { textAlign: 'left', padding: '1rem 1.25rem', borderBottom: '2px solid #e5e7eb', background: '#f9fafb', color: '#374151', fontWeight: '700', fontSize: '0.95rem', whiteSpace: 'nowrap' },
  td: { padding: '1rem 1.25rem', borderBottom: '1px solid #f3f4f6', color: '#4b5563', fontSize: '0.95rem' },
  roleSelect: { padding: '0.4rem 0.6rem', borderRadius: '6px', border: '1px solid', fontWeight: '600', fontSize: '0.9rem', background: 'white', cursor: 'pointer' },
  statusBadge: { padding: '0.25rem 0.75rem', borderRadius: '999px', fontSize: '0.85rem', fontWeight: '600' },
  actionBtn: { background: 'none', border: 'none', cursor: 'pointer', color: '#1e40af', fontSize: '0.9rem', marginRight: '0.6rem', fontWeight: '600' },
  code: { background: '#f1f5f9', padding: '0.2rem 0.5rem', borderRadius: '4px', fontSize: '0.85rem', fontFamily: 'monospace' },
  fileInput: { padding: '0.6rem', border: '1px dashed #d1d5db', borderRadius: '8px', width: '100%', cursor: 'pointer', background: '#f9fafb', fontSize: '0.95rem' },
  fileHint: { color: '#9ca3af', fontSize: '0.85rem', marginTop: '0.35rem' },
  ...
  checkLabel: { display: 'flex', alignItems: 'center', fontSize: '1rem', color: '#374151', cursor: 'pointer', padding: '0.35rem 0.75rem', borderRadius: '6px', background: 'white', border: '1px solid #e2e8f0' },
  optionalTag: { color: '#9ca3af', fontWeight: '400', fontSize: '0.85rem', marginLeft: '0.5rem' },
  targetTag: { display: 'inline-block', padding: '0.2rem 0.6rem', borderRadius: '999px', fontSize: '0.82rem', fontWeight: '600', marginRight: '0.25rem', marginBottom: '0.15rem', textTransform: 'capitalize' },
  allTag: { color: '#9ca3af', fontSize: '0.9rem' },
  subTabs: { display: 'flex', gap: '0.5rem', marginBottom: '1.25rem', flexWrap: 'wrap' },
  subTab: { padding: '0.6rem 1.4rem', border: '2px solid #e2e8f0', borderRadius: '8px', background: 'white', cursor: 'pointer', color: '#64748b', fontWeight: '600', fontSize: '0.95rem' },
  ...
  courseRow: { display: 'flex', alignItems: 'center', padding: '0.85rem 1rem', borderRadius: '8px', border: '1px solid', cursor: 'pointer', transition: 'all 0.15s' },
  courseRowTitle: { fontWeight: '500', color: '#1e293b', fontSize: '1rem' },
  tagList: { display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginTop: '0.5rem' },
  userTag: { display: 'flex', alignItems: 'center', gap: '0.35rem', padding: '0.35rem 0.75rem', background: '#ede9fe', color: '#6d28d9', borderRadius: '999px', fontSize: '0.9rem', fontWeight: '600' },
  removeTag: { background: 'none', border: 'none', cursor: 'pointer', color: '#6d28d9', fontSize: '1rem', lineHeight: 1, padding: 0, fontWeight: '700' },
  progressBar: { background: '#e2e8f0', borderRadius: '999px', height: '22px', position: 'relative', overflow: 'hidden' },
  progressFill: { background: '#1e40af', height: '100%', borderRadius: '999px', transition: 'width 0.3s ease' },
  progressText: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '0.8rem', fontWeight: '700', color: 'white' },
  questionBlock: { background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '10px', padding: '1.25rem' },
  optionLetter: { width: '28px', height: '28px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '700', fontSize: '0.85rem', flexShrink: 0 },
